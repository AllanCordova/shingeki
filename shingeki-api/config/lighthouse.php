...
return [
    ...
    */
    ...
    'query_cache' => [
        /*
         * Query caching. Off in local: database/file stores cannot safely
         * serialize GraphQL DocumentNode (risk of __PHP_Incomplete_Class).
         */
        'enable' => env('LIGHTHOUSE_QUERY_CACHE_ENABLE', env('APP_ENV') !== 'local'),

        /*
         * Cache mechanism:
         * - store: Laravel cache store (Redis/Memcached preferred)
         * - opcache: PHP files on disk (safe default when CACHE_STORE is database/file)
         * - hybrid: opcache first, shared store as fallback
         */
