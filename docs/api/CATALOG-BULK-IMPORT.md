...
| `category` | sim | `SQL_INJECTION`, `XSS`, `CSRF`, `COMMAND_INJECTION`, `PATH_TRAVERSAL`, `SSRF`, `XXE`, `LDAP_INJECTION`, `NOSQL_INJECTION`, `IDOR`, `OPEN_REDIRECT`, `SSTI`, `JWT_CONFUSION`, `SUPPLY_CHAIN`, `SECRET_LEAK` |
