...
import { NOTIFICATION_BELL_PAGE_SIZE } from "@/lib/contracts/common/common";
import { queryKeys } from "@/lib/query-keys";

const POLL_MS = 20_000;
const EMPTY_NOTIFICATIONS: NonNullable<
  UserNotificationsResponse["notifications"]
> = [];
...
export function useNotifications(
  ...
  return {
    notifications: query.data?.notifications ?? EMPTY_NOTIFICATIONS,
