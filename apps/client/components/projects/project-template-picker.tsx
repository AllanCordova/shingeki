...
import { useCreateSystem } from "@/lib/hooks/system/use-systems";
...
export function ProjectTemplatePicker({
  ...
  const { createSystem, isLoading: isCreatingSystem } = useCreateSystem();
          ...
          <Card key={template.id} className="flex flex-col">
            ...
            <CardContent className="mt-auto">
              <Button
                ...
                variant="outline"
                className="w-full"
                isLoading={isCreatingProject || isCreatingSystem}
