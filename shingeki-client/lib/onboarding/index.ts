...
/** Preferencia persistente (sobrevive a login/logout). */
...
/**
 * Auto-abre só para contas sem projetos e que ainda não dispensaram o guia.
 * Com projetos, o guia só volta pelo botão em /projetos.
 */
